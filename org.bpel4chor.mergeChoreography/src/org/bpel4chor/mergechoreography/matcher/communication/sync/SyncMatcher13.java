 ...
 * 
 */
public class SyncMatcher13 implements SyncMatcher {
	...
	public MergePattern match(MessageLink mlSend, MessageLink mlReply, ChoreographyPackage pkg) {
		...
		this.pattern = new SyncPattern13(this.envSend, this.envReply, pkg);
		...
		this.log.info("SyncMatcher 1.3 R() instanceof Receive : " + cond1.evaluate());
		this.results.add(cond2.evaluate());
		this.log.info("SyncMatcher 1.3 R() SuccS().size() == 0 : " + cond2.evaluate());
