 ...
 * 
 */
public class AsyncMatcher11 implements AsyncMatcher {
	...
	public MergePattern match(MessageLink link, ChoreographyPackage pkg) {
		...
		this.pattern = new AsyncPattern11(this.env, pkg);
		
		// Set the conditions
		Condition cond1 = new Condition(this.env.getR() instanceof Receive);
		
		this.results.add(cond1.evaluate());
		this.log.info("AsyncMatcher 1.1 R() instanceof Receive : " + cond1.evaluate());
