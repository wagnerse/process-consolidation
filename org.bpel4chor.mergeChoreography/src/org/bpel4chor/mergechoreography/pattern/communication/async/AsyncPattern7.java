...
public class AsyncPattern7 extends CommunicationBasePattern implements CommunicationPattern {
	
	public AsyncPattern7(MessageLink messageLink, ChoreographyPackage choreographyPackage, LinkEnvironment environment) {
	...
	public void merge() {
		...
		this.logger.log(Level.INFO, "" + this.choreographyPackage.resolveActivityInMergedProcess(inv2.getName(), receiver));
