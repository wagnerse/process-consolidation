...
public class ChoreographyMergerTest {
	...
	private static String outputPath = "D:\\Arbeit\\Diplom\\eclwkspBPEL\\MeineTestChoreos\\bpelContent\\MergeOutput";
	...
	public void test() {
		for (Map.Entry<String, String> entry : ChoreographyMergerTest.patterns.entrySet()) {
			...
			choreographyMerger.merge(ChoreographyMergerTest.outputPath + java.io.File.separator + entry.getValue());
		}
	}
